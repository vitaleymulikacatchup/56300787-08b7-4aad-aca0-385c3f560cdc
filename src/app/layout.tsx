...
export const metadata: Metadata = {
  title: "TechAcademy - Learn Programming & IT Skills",
  description: "Master Python, web development, databases, and cloud computing with our industry-focused IT school. Learn from experts, get career guidance, and build your tech future.",
  keywords: "IT school, programming courses, web development, Python training, coding bootcamp, tech education",
  metadataBase: new URL("https://techacademy.com"),
  alternates: {
    canonical: "https://techacademy.com"
  },
  openGraph: {
    title: "TechAcademy - Learn Programming & IT Skills",
    description: "Master in-demand tech skills with hands-on training from industry professionals.",
    type: "website",
    siteName: "TechAcademy",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765898331574-9q9nvepm.jpg",
        alt: "TechAcademy Students Learning"
      }
    ]
  },
  twitter: {
    ...
    title: "TechAcademy - Learn Programming & IT Skills",
    description: "Master in-demand tech skills with hands-on training from industry professionals.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765898331574-9q9nvepm.jpg"]
  },
  robots: {
    index: true,
    follow: true
